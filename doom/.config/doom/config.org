#+TITLE: Doom Emacs Configuration#+SUBTITLE: The Methods, Management, and Menagerie of Madness
#+AUTHOR: hoangolo
...
*** Theming
**** Fonts
I usually like the 'JetBrains Mono' font, especially in the terminal and everything else related to source code, but in Emacs, I much prefer the 'Iosevka' font, as I feel like it has improved rendering in the GUI version. because I do occasionally switch around to JetBrains, I like to keep them both in the config, and just comment out the one I'm not using at the moment.
#+begin_src emacs-lisp :tangle yes
...
**** Theming
I have really grown to like the [[https:github.com/ogdenwebb/emacs-kaolin-themes][kaolin-themes]] collection, I much prefer over the visually rather ugly standard collection of ~doom-themes~. Kaolin themes have very good compatibility with dialog boxes from ~ivy~ and others, which I will get to later.
#+begin_src emacs-lisp :tangle yes
