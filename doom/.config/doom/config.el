...
(if IS-LINUX
    (setq doom-font (font-spec :family "Victor Mono" :size 14 :weight 'medium)
          doom-big-font (font-spec :family "Victor Mono" :size 22 :weight 'medium)
...
(when IS-MAC (add-hook 'ns-system-appearance-change-functions 'my/apply-theme))
